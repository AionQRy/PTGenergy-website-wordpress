...
?>
<article id="post-<?php the_ID(); ?>" class="post-card-two card-calendar-1 card-3_column_calendar">
    <div class="main-object">
            ...
            <div class="box-cat">
                <span class="cat-text">
                    ...
                    <div class="flex-calendar">
                        <span class="m-y">
                            <?php echo date_i18n( "M", $str_format ); ?>
                        </span>
                        <span class="m-y-m">
                            <?php 
                            if (get_locale() == 'en') {
                                echo date_i18n( "y", $str_format );
                            }
                            if (get_locale() == 'th') {
                                echo date_i18n( "y", $str_format )+43;
                            }
                            ?>
                        </span>
                    </div>
        ...
        <div class="object-2">
            ...
            <div class="box-btn_readmore">
                <a href="<?php echo get_permalink(); ?>"><?php yp_text('รายละเอียด','Read More');; ?><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="9 18 15 12 9 6"></polyline></svg></a>
            </div>
        </div>
        <div class="object-3">
