...
?>
<article id="post-<?php the_ID(); ?>" class="card-hot_post <?php if ($no_wow == '') { } else { echo 'wow fadeInUp'; } ?>">
	...
	<div class="post-info">
        ...
        <div class="excerpt-card_hot">
            <?php the_excerpt(); ?>
        </div>
        <div class="box-post_card">
            <a href="<?php echo get_permalink(); ?>" class="read_more"><?php yp_text('อ่านเพิ่มเติม','Read More'); ?><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="9 18 15 12 9 6"></polyline></svg></a>
