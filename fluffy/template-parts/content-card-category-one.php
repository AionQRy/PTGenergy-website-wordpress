...
?>
<article id="post-<?php the_ID(); ?>" class="card-cat_post <?php if ($no_wow == '') { } else { echo 'wow fadeInUp'; } ?>">
	...
	<div class="post-info">
		...
		<?php yp_text( 'ครั้ง', 'View' ); ?>
				</span>
                <div class="excerpt-card">
                    <?php the_excerpt(); ?>
                </div>
		</div>
			<a href="<?php the_permalink();  ?>" class="read_more"><?php yp_text('อ่านต่อ','Read More'); ?><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="9 18 15 12 9 6"></polyline></svg></a>
	</div>
</article>
