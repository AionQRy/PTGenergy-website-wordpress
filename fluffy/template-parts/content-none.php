...
<section class="no-results not-found">
	<header class="page-header">
		<h2 class="page-title"><?php esc_html_e( 'Nothing Found', 'fluffy' ); ?></h2>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		elseif ( is_search() ) :
			...
			<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'fluffy' ); ?></p>
			<?php
			get_search_form();
