...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://hris.pt.co.th/HrisService/workflow-getapproverstep-dynamic',
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    'Cookie: ApplicationGatewayAffinity=ee6237ada0daa2d658014cad5d543a8f; ApplicationGatewayAffinityCORS=ee6237ada0daa2d658014cad5d543a8f'
  ),
));
...
$manager_empId = '';
foreach ($response->workflowApprover as $value) {
  if ($value->numLvl >= 9) {
...
if ( $manager_empId != '') {
  $user = get_user_by('login', $manager_empId);
  ...
  ?>
   ...
   <br>
   <p style="margin: 0;">หากคุณไม่สามารถเข้าลิงก์ รายละเอียดประกาศได้ คุณสามารถคัดลอกลิงก์ด้านล่างนี้เพื่อไปวางใช้งานบนบราวเซอร์ได้โดยตรง</p>
   <p style="margin: 0;">
  ...
  <?php
   ...
   update_field('manager_userid',$manager_empId,$post_id);

   wp_send_json_success([
      'result' => [
          'redirectUrl' => home_url('/request-contents'),
