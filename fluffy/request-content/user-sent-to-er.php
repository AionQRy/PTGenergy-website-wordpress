...
foreach ($er_users_list_s as $value) {
    ...
    update_field('reStatus','status_06',$current_post_id);
    ?>
    <h3>เรียน ทีม ER</h3>
    ...
    <?php
     $output_string = ob_get_contents();
      ...
      // request_sentmail($er_mail,'[ER แก้ไขข้อมูล] เรื่อง: '.get_the_title($current_post_id),$output_string );
    ?>
<?php } ?>
