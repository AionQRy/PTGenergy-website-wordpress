<?php
 ...
 foreach ($er_users_list_s as $value) {
    ...
    update_field('reStatus','status_07',$current_post_id);
    ?>
    <h3>เรียน ทีม ER</h3>
    ...
    <?php
     $output_string = ob_get_contents();
      ...
      // request_sentmail($er_mail,'[User ยืนยันถูกต้องแล้ว] เรื่อง: '.get_the_title($current_post_id),$output_string );
    ?>
<?php } ?>
...
<?php
  ...
  if ($reDetailUser == '') {
    $reDetailUser = "User ยืนยันถูกต้องแล้ว";
  }
  $row = array(
