...
update_field('reStatus','status_02',$current_post_id);
?>
...
<?php
 $output_string = ob_get_contents();
  ob_end_clean();
  // request_sentmail($manager_email,'[ตีกลับคำร้อง] เรื่อง: '.get_the_title($current_post_id),$output_string );
