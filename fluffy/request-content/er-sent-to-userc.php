...
update_field('reStatus','status_08',$current_post_id);
...
<?php
 $output_string = ob_get_contents();
  ob_end_clean();
  // request_sentmail($manager_email,'[ประกาศเรียบร้อยแล้ว] เรื่อง: '.get_the_title($current_post_id),$output_string );
  ...
  if ($reDetailUser == '') {
    $reDetailUser = "ประกาศเรียบร้อยแล้ว";
  }
  $row = array(
